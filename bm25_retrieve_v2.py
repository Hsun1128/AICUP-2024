...
def load_data(source_path: str, files_to_load: List[int]) -> Dict[int, List[Document]]:
    """
    載入參考資料
...
# 讀取單個PDF文件並返回其文本內容
def read_pdf(pdf_loc: str, splitter: RecursiveCharacterTextSplitter=splitter, page_infos: Optional[List[int]]=None) -> List[Document]:
    """
    讀取PDF文件並進行文本處理
