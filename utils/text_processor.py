...
class TextProcessor:
    def __init__(self, stopwords_filepath: str, bm25_k1: float=1.2, bm25_b: float=0.75, use_expansion: bool=False, expanded_topn: int=3, chunk_size: int=500, overlap: int=50, expansion_model_path: str='../word2vec/wiki.zh.bin', use_faiss: bool=False):
        """
        初始化文本處理器
